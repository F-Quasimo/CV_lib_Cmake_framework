...
{
  GridAndStride(int g0, int g1, int strd) { this->grid0 = g0;
    this->grid1 = g1;
    this->stride = strd;
  }
    int grid0;
...
YoloX::YoloX(std::string param_path,
             std::string bin_path,
             float prob_thresh,
             bool use_vulkan,
...
// #endif
//     yolox_net.register_custom_layer("YoloV5Focus", YoloV5Focus_layer_creator);
//     yolox_net.opt.num_threads = ncnn::get_big_cpu_count();
//     yolox_net.opt.blob_allocator = &blob_pool_allocator;
//     yolox_net.opt.workspace_allocator = &workspace_pool_allocator;
